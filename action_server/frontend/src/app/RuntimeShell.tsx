...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Schedules', path: '/schedules', icon: ClockIcon },
  { label: 'Robots', path: '/robots', icon: RobotsIcon },
  { label: 'Work Items', path: '/work-items', icon: WorkItemsIcon },
  { label: 'Analytics', path: '/analytics', icon: AnalyticsIcon },
  { label: 'OpenAPI spec', path: '/openapi', icon: OpenApiIcon },
];
