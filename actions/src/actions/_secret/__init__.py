...
class Secret:
    ...
    def model_validate(cls, value: str) -> "Secret":
        ...
        Note: the model_validate method is used for compatibility with
            the pydantic API.
        """
        from actions._secret._secret import _RawSecret
    ...
    def from_action_context(
        ...
        """
        from actions._secret._secret import _SecretInActionContext
...
class OAuth2Secret(Generic[ProviderT, ScopesT]):
    ...
    def model_validate(cls, value: dict) -> "OAuth2Secret":
        ...
        Note: the model_validate method is used for compatibility with
            the pydantic API.
        """
        from actions._secret._oauth2_secret import _RawOauth2Secret
    ...
    def from_action_context(
        ...
        """
        from actions._secret._oauth2_secret import _OAuth2SecretInActionContext
