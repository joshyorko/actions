...
def session_cache(func):
    ...
    will return it on any new invocation until actions-core finishes running
    all actions.
    ...
    """
    from actions._hooks import after_all_actions_run
    from actions._lifecycle import _cache
...
def action_cache(func):
    ...
    Args:
        func: wrapped function.
    """
    from actions._hooks import after_action_run
    from actions._lifecycle import _cache
...
def get_output_dir() -> Optional[Path]:
    ...
    """
    from actions._config import get_config
