...
from actions._protocols import IAction, IContext, Status

if typing.TYPE_CHECKING:
    from actions._action_context import ActionContext, RequestContexts
...
class Action:
        ...
        if not param_type:
            ...
            if param_type not in SUPPORTED_TYPES_IN_SCHEMA:
                ...
                if hasattr(param_type, "model_json_schema"):
                    ...
                    from actions._remove_refs import replace_refs
    ...
    def managed_params_schema(self) -> Dict[str, Any]:
        ...
        from actions._commands import _get_managed_param_type, _is_managed_param
        ...
        for param in sig.parameters.values():
            if _is_managed_param(self._pm, param.name, param=param):
                ...
                if tp == "OAuth2Secret":
                    ...
                    from actions._secret import get_secret_spec_from_annotation
    ...
    def input_schema(self) -> Dict[str, Any]:
        from actions._commands import _is_managed_param
    ...
    def __typecheckself__(self) -> None:
        from actions._protocols import check_implements
...
class Context:
    ...
    def register_lifecycle_prints(self):
        from actions._hooks import after_action_run, before_action_run
