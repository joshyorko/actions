    ...
    while module_name:
        if module_name not in modules:
            try:
                ...
                module = ModuleType(
                    module_name,
                    doc="Empty module created by actions-core.",
                )
...
def collect_actions(
    ...
    from actions import _constants, _hooks
    ...
    def on_func_found(func, options: Dict):
        from actions._exceptions import ActionsError
    ...
    from actions._action import Action
