...
This build uses the **[joshyorko/rcc](https://github.com/joshyorko/rcc)** fork (v18.17.6) - a fully open-source version of RCC with several key benefits:
...
- **RCC**: [joshyorko/rcc](https://github.com/joshyorko/rcc) v18.17.6+
