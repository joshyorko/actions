...
class RuntimeAdapter(Protocol):
    """Minimal processing protocol consumed by the runtime facade."""

    def reserve_input(self) -> str: ...
    @overload
    def release_input(
        self, item_id: str, state: State, exception: dict[str, Any] | None = None
    ) -> None: ...
    @overload
    def release_input(
        self,
    ...
    def release_input(self, item_id: str, state: State, *args: Any, **kwargs: Any) -> None: ...
    def create_output(self, parent_id: str, payload: JSONType = None) -> str: ...
    ...
    def add_file(self, item_id: str, name: str, *args: Any) -> None: ...
    def remove_file(self, item_id: str, name: str) -> None: ...


@runtime_checkable
class ManagedAdapter(Protocol):
    """Optional producer and management operations outside runtime processing."""

    def seed_input(self, payload: JSONType = None, files=None, queue_name=None) -> str: ...
    def list_items(self, queue_name=None, state=None, limit: int = 100) -> list[dict[str, Any]]: ...
    def get_item(self, item_id: str) -> dict[str, Any]: ...
    def delete_item(self, item_id: str) -> None: ...
    def get_queue_stats(self, queue_name=None) -> dict[str, int]: ...
    def close(self) -> None: ...
